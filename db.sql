CREATE DATABASE  IF NOT EXISTS `pranali` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pranali`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: pranali
-- ------------------------------------------------------
...
-- Dump completed on 2024-03-08 19:07:47
CREATE DATABASE  IF NOT EXISTS `zink` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `zink`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: zink
-- ------------------------------------------------------
-- Server version	8.0.29
...
CREATE TABLE `just` (
  ...
  `new_profile` varchar(13) DEFAULT NULL,
  `name` varchar(10) DEFAULT NULL,
  `designation` varchar(20) DEFAULT NULL,
  `marks` float(4,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `notnul`
--

DROP TABLE IF EXISTS `notnul`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notnul` (
  `roll_no` int DEFAULT NULL,
  `name` varchar(20) DEFAULT NULL,
  CONSTRAINT `che_con` CHECK ((`roll_no` > 2))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2024-03-08 19:07:48
CREATE DATABASE  IF NOT EXISTS `cre` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cre`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: cre
-- ------------------------------------------------------
-- Server version	8.0.29
...
--
-- Table structure for table `dhiraj`
--

DROP TABLE IF EXISTS `dhiraj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dhiraj` (
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `human` (
  `per` decimal(4,2) DEFAULT NULL,
  `name` varchar(30) DEFAULT NULL,
  KEY `per` (`per`),
  CONSTRAINT `human_ibfk_1` FOREIGN KEY (`per`) REFERENCES `manus` (`per`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mahesh`
--

DROP TABLE IF EXISTS `mahesh`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mahesh` (
  `name` varchar(20),
...
CREATE TABLE `manus` (
  ...
  PRIMARY KEY (`per`),
  CONSTRAINT `chk_per` CHECK ((`per` < 30.00))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `vikram`
--

DROP TABLE IF EXISTS `vikram`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vikram` (
  `name` varchar(20) DEFAULT NULL,
  ...
  CONSTRAINT `vikram_chk_1` CHECK ((`age` > 18)),
  CONSTRAINT `vikram_chk_2` CHECK ((`age` > 18))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2024-03-08 19:07:50
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bonus` (
  `workRefId` int DEFAULT NULL,
  `bonus_date` datetime DEFAULT NULL,
  `bonus_amount` float DEFAULT NULL,
  KEY `workRefId` (`workRefId`),
  CONSTRAINT `bonus_ibfk_1` FOREIGN KEY (`workRefId`) REFERENCES `worker` (`worker_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `title` (
  `workRefId` int DEFAULT NULL,
  `worker_title` varchar(55) DEFAULT NULL,
...
-- Dump completed on 2024-03-08 19:07:50
CREATE DATABASE  IF NOT EXISTS `constraints` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `constraints`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: constraints
-- ------------------------------------------------------
-- Server version	8.0.29
...
CREATE TABLE `details` (
  ...
  `city` varchar(20) DEFAULT NULL,
  KEY `name` (`name`),
  CONSTRAINT `details_ibfk_1` FOREIGN KEY (`name`) REFERENCES `customer` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2024-03-08 19:07:51
CREATE DATABASE  IF NOT EXISTS `nested` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nested`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
-- Dump completed on 2024-03-08 19:07:51
CREATE DATABASE  IF NOT EXISTS `joindb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `joindb`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: joindb
-- ------------------------------------------------------
-- Server version	8.0.29
...
--
-- Table structure for table `redbus`
--

DROP TABLE IF EXISTS `redbus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `redbus` (
...
--
-- Table structure for table `state_a`
--

DROP TABLE IF EXISTS `state_a`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `ut1` (
  ...
  `gsql` int DEFAULT NULL,
  KEY `RN` (`RN`),
  CONSTRAINT `ut1_ibfk_1` FOREIGN KEY (`RN`) REFERENCES `stud` (`RN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2024-03-08 19:07:51
CREATE DATABASE  IF NOT EXISTS `mock` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mock`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
CREATE TABLE `b` (
  ...
  `city` varchar(20) DEFAULT NULL,
  KEY `id` (`id`),
  CONSTRAINT `b_ibfk_1` FOREIGN KEY (`id`) REFERENCES `z` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `neosoft`
--

DROP TABLE IF EXISTS `neosoft`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `neosoft` (
  ...
  `salary` int DEFAULT NULL,
  CONSTRAINT `neosoft_chk_1` CHECK ((`Id` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `product_sold` varchar(20) DEFAULT NULL,
  `sell_prize` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 VIEW `staff_view` AS select `staff`.`Name` AS `name`,`staff`.`salary` AS `salary` from `staff` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2024-03-08 19:07:52
CREATE DATABASE  IF NOT EXISTS `clause` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `clause`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: clause
-- ------------------------------------------------------
-- Server version	8.0.29
